...
class DetailBuildingActivity : AppCompatActivity() {
        ...
        binding.btnPredict.setOnClickListener {
            ...
            if (buildingResponse != null) {
                ...
                if (!isValidLocation(location)) {
                    Toast.makeText(this, "Lokasi belum support AI prediction", Toast.LENGTH_SHORT).show()
    ...
    private fun makePrediction() {
        ...
        if (buildingResponse != null) {
            ...
            Log.d("DetailBuildingActivity", "Making prediction with details: Bathroom: $bathroom, Bedroom: $bedroom, Building Area: $buildingArea, Land Area: $landArea, Location: $location")
